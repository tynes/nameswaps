...
const HostList = require('./hostlist'); // TODO: need this still
const InvItem = require('./invitem');
const packets = require('./packets');
const consensus = require('../protocol/consensus'); // TODO: is this needed
    ...
    for (const item of items) {
      switch (item.type) {
        ...
        case invTypes.SWAPPROOF: {
          ...
          const proof = await this.getSwapProof(peer, item);
