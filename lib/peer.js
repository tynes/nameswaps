...
// TODO: change magic
// only accept type pubkey without verification
...
class Peer extends EventEmitter {
  ...
  constructor(options) {
    ...
    // also need another filter for addrWitnesses
  ...
  flushInv() {
    ...
    // TODO(mark): make sure each item has a hash field
  ...
  sendVersion() {
    ...
    packet.noRelay = this.options.noRelay; // TODO: handle this
    this.send(packet);
  }
  ...
  // TODO(mark): figure out this function
  fulfill(packet) {
    switch (packet.type) {
